 ...
 */
@Component
public class MonkeyziAuthorizeConfigManager implements AuthorizeConfigManager {
	 ...
	 */
	@Autowired
	public MonkeyziAuthorizeConfigManager(List<AuthorizeConfigProvider> authorizeConfigProviders) {
