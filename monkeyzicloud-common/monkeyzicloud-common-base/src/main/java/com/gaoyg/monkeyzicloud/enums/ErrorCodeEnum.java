...
public enum  ErrorCodeEnum {
    ...
    UCLOUD10015005(10015005, "保存权限信息失败"),
    /**
     * 组织
     */
    UCLOUD10016001(10016001, "找不到组织信息,groupId=%s"),
    UCLOUD10016002(10016002, "该组织下还有其他组织，不能将其删除, Pid=%s"),
    UCLOUD10016003(10016003, "该组织下绑定的用户，不能将其删除, groupId=%s"),
    UCLOUD10016004(10016004, "组织Id不能为空"),
    UCLOUD10016005(10016005, "该组织不能被删除"),
    UCLOUD10016006(10016006, "找不到上级组织, groupId=%s"),
    UCLOUD10016007(10016007, "组织状态不存在"),
    UCLOUD10016008(10016008, "操作越权, 启用子节点, 必须先启用父节点"),
    UCLOUD10016009(10016009, "更新组织信息失败,groupId=%s");
